...
require_once SIMBIO . 'simbio_FILE/simbio_file_upload.inc.php';
require_once MDLBS . 'system/biblio_indexer.inc.php';
...
if (isset($_GET['action']) && $_GET['action'] == 'history') {
  ...
  <div class="bnt btn-group"><div class="btn btn-info" data-toggle="collapse" data-target="#batchItemDetail" aria-expanded="false" aria-controls="batchItemDetail">' . __('Options') . '</div>';
    ...
    $js = '';
    \SLiMS\Plugins::getInstance()->execute('advance_custom_field_form', ['form' => $form, 'itemID' => $itemID, 'rec_d' => $rec_d, 'js' => &$js]);
